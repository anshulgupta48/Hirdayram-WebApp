...
const NotFound: React.FunctionComponent = () => {
  return (
    <div className='flex flex-col font-sans'>
      ...
      <div className='min-h-[460px] w-full bg-[#FFFFFF] flex flex-col justify-center items-center gap-[25px]'>
        <img src={NotFoundBanner} alt="NotFound-Banner" className='h-[200px] w-[500px]' />
        <h3 className='mt-[10px] text-[#16171A] text-[30px] font-bold leading-none'>Sorry We Can't Find That Page!</h3>
